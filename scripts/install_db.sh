...
# STOP script if any command fails (Key for debugging!)
set -e 
...
# We look into /etc/postgresql/ to see what version folder exists (e.g., 14, 15, 16)
...
# --- CONFIGURATION ---
# Now we use the variables $PG_CONF and $PG_HBA instead of hardcoded paths
